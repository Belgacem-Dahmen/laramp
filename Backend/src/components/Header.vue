...
const navigation = [
    ...
    { name: 'Adherents', to: '/adherents', current: false },
    { name: 'Demandes', to: '/demandes', current: false },
    { name: 'Formations', to: '/formations', current: false },
    { name: 'Exports', to: '/exports', current: false },
]
